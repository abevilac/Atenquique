...
Figures \ref{Fig10} and \ref{Fig11} show the histograms of flow height and speed at the three selected sites, either their maximum and their value at $t=2400$ s. They confirm what summarized in the previous section. In summary, at Site \#3, typical flow height at $t_f$ is slightly higher in MC and lower in VS, but the second model has a tail of very large thickness values. Maximum height values are significantly larger in VS than in the other models. Speed at $t_f$ is significantly lower in MC than in PF and VS. These have similar modes, but the latter has a wider spread of values.
\\***work in progress***\\
We also report the empirical information concerning these quantities. In particular:
\begin{itemize}
