...
\caption{Partial solutions inputs in PF experimental design supported over one of the four different hyperplanes described in Table 1, (a-c) data refer to Figure \ref{Fig11_0}, (c-d) to Figure \ref{Fig11}, (e-f) to Figure \ref{Fig11a}. (a-c-e) are projected along the $V$ coordinate, and (b-d-f) $\phi_2$ coordinate.}
\label{FigA2}
\end{figure}
