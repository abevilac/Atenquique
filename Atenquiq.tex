...
\caption{Partial solutions inputs in PF experimental design supported over one of the four different hyperplanes described in Table 1, data refer to Figure \ref{Fig11a}. All plots are projected along the $V$ coordinate. The color expresses the considered data: yellow is deposit thickness \citep{Saucedo2008}, red is flow speed \citep{Pierson1985}.}
\label{FigA2}
\end{figure}
